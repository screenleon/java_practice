...
public class ShapesJPanel extends JPanel{
    ...
    public void paintComponent(Graphics g){
        ...
        g2d.fill(new Ellipse2D.Double(5, 30, 65, 50));
        ...
        g2d.fill(new RoundRectangle2D.Double(155, 30, 75, 100, 50, 80));
        
        g2d.setPaint(Color.WHITE);
        g2d.setStroke(new BasicStroke(6.0f));
        //defined by a framing rectangle, start angle, angular extent (length of the arc), 
        //and a closure type (OPEN, CHORD, or PIE).
        g2d.draw(new Arc2D.Double(240, 30, 75, 100, 0, 270, Arc2D.PIE));
        
        g2d.setPaint(Color.GREEN);
        g2d.draw(new Line2D.Double(390, 30, 320, 150));
